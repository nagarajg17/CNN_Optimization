...
class CNNApi(APIView):
	...
	def post(self,request):
		...
		return Response({'left_eye_result':left_eye_result,'right_eye_result':right_eye_result,'left_eye_symptoms':left_eye_symptoms, 'right_eye_symptoms':right_eye_symptoms})
